    ...
    <div className="min-h-screen bg-[#0D1117]">
      ...
      <section className="relative min-h-[100vh] md:min-h-[80vh] flex items-center">
        ...
        <div className="absolute inset-0">
          <img
            src="/uploads/rail_industry.webp"
            alt="Rail operations"
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-300">
                      ...
                      protection, monitor confined space operations, and
                      maintain rigorous compliance with FRA regulations.
                    </p>
                  </div>
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-[#eba200]">
                    ...
                    <ul className="space-y-2 text-gray-300">
                      ...
                      <li className="flex items-center gap-2">
                        <ArrowRight className="h-4 w-4 text-[#eba200]" />
                        Real-time hazard detection for electrical & confined
                        space work
                      </li>
                      <li className="flex items-center gap-2">
                        <ArrowRight className="h-4 w-4 text-[#eba200]" />
