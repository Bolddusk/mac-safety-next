            ...
            <div className="bg-[#16171a] border border-gray-800 rounded-2xl p-8 space-y-8">
              <div>
                ...
                <p className="text-gray-300">
                  Mining operations face unique challenges in underground
                  safety, heavy equipment operation, and environmental hazards.
                  MAC Safety embeds specialized consultants who understand MSHA
                  regulations and critical mining safety protocols.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300">
                    NIXN&apos;s AI-driven analytics monitor ventilation systems,
                    ground control measures, and equipment operations—ensuring
                    both worker safety and production efficiency in challenging
