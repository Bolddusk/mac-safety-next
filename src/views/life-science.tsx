...
export default function LifeScienceIndustryPage() {
  return (
    <div className="min-h-screen bg-[#0b0b0d] font-alliance">
      <section className="relative min-h-[100vh] md:min-h-[80vh] flex items-center pt-32">
        <div className="absolute inset-0">
          <img
            src="/uploads/Life science industry.jpg"
            alt="Life science operations"
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-2xl">
                Precision Risk Management for Regulated Environments
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="bg-[#16171a] border border-gray-800 rounded-2xl p-8 space-y-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                  Advanced Life Sciences Safety Solutions
                </h2>
                <p className="text-gray-300">
                  Pharmaceutical and biotech facilities demand rigorous safety
                  protocols to protect workers, products, and compliance
                  standards. MAC Safety embeds highly trained consultants who
                  specialize in cleanroom safety, hazardous material handling,
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300">
                    With NIXNos&apos; AI-driven risk tracking, we monitor biosafety
                    hazards, ensure GMP compliance, and enhance lab
                    safety—reducing incidents while protecting product
                    integrity.
                  </p>
                </div>
                <div className="space-y-4">
