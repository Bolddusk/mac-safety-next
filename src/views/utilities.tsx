    ...
    <div className="min-h-screen bg-[#0b0b0d] font-alliance">
      <section className="relative min-h-[100vh] md:min-h-[80vh] flex items-center pt-32">
        <div className="absolute inset-0">
          <img
            src="/uploads/Utilies Industry.jpg"
            ...
            <div className="bg-[#16171a] border border-gray-800 rounded-2xl p-8 space-y-8">
              <div>
                ...
                <p className="text-gray-300">
                  ...
                  hazards, confined spaces, and critical infrastructure demands.
                  MAC Safety deploys specialized consultants who understand grid
                  reliability, compliance requirements, and worker protection in
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300">
                    ...
                    regulatory compliance across multiple facilities—maintaining
                    both worker safety and operational continuity.
                  </p>
                </div>
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-[#eba200]">
