...
function FieldkitInterestForm() {
  ...
  const inputStyles =
    "bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:border-[#eba200] focus:ring-[#eba200]";
...
export default function Fieldkit() {
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start mb-16">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  className="bg-[#eba200] hover:bg-[#d49400] text-black font-semibold px-8 py-3 rounded-full font-alliance"
                  data-testid="button-whitepaper"
                  onClick={() => {
                    const elem = document.getElementById("download_form");
                    elem?.scrollIntoView();
                  }}
                >
                  Download Whitepaper
                ...
                <Button
                  variant="outline"
                  className="border-2 border-[#eba200] text-[#eba200] hover:bg-[#eba200]/10 px-8 py-3 rounded-full font-alliance"
            ...
            >
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                <div className="space-y-6">
                  <div className="bg-gray-800 border border-gray-700 p-8 rounded-2xl">
                    ...
                    <p className="text-[#eba200] text-sm mb-4 font-alliance">
                      ~768 Wh LFP • 800 W AC
                    </p>
              ...
              <div className="flex flex-wrap justify-center gap-3 mt-8">
                {[
                  ...
                  <span
                    key={feature}
                    className="px-4 py-2 text-xs bg-gray-800 text-gray-300 rounded-full border border-gray-700 font-alliance"
                  >
                    {feature}
                  </span>
                ))}
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto font-alliance">
                  ...
                  revolutionary form factor, redefining what&apos;s possible for
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                <div className="space-y-6">
                  <div className="text-center p-6 bg-[#1f2024] rounded-2xl border border-gray-800">
                    <h3 className="text-2xl font-bold text-[#eba200] mb-2 font-alliance">
                      FIELDKIT
                    </h3>
                    <p className="text-gray-500 text-sm font-alliance">
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#1f2024] border border-gray-800 p-6 rounded-2xl">
                      <h4 className="text-white font-semibold mb-2 font-alliance">
                        Mobility
                      </h4>
                ...
                <div className="space-y-6">
                  <div className="text-center p-6 bg-gray-100 rounded-2xl border border-gray-800">
                    <h3 className="text-2xl font-bold text-gray-400 mb-2 font-alliance">
                      Legacy Cabinet
                    </h3>
                    <p className="text-gray-400 text-sm font-alliance">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-100 border border-gray-800 p-6 rounded-2xl">
                      <h4 className="text-gray-500 font-semibold mb-2 font-alliance">
                        Mobility
                      </h4>
                      <p className="text-gray-400 text-sm font-alliance">
              ...
              <div className="text-center pt-8">
                <p className="text-gray-400 text-sm font-alliance">
                  Runtimes are scenario-dependent; &apos;legacy cabinet&apos;
                  specs summarized from public datasheets.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section id="download_form" className="py-20 md:py-28 bg-[#0b0b0d]">
        <div className="container mx-auto px-6 md:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
