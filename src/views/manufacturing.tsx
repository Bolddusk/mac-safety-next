    ...
    <div className="min-h-screen bg-[#0b0b0d] font-alliance">
      <section className="relative min-h-[100vh] md:min-h-[80vh] flex items-center pt-32">
        <div className="absolute inset-0">
          <img
            src="/uploads/Manufacturing Industry.jpg"
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-2xl">
                Eliminating Hazards, Enhancing Productivity
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="bg-[#16171a] border border-gray-800 rounded-2xl p-8 space-y-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                  Advanced Manufacturing Safety Solutions
                </h2>
                <p className="text-gray-300">
                  In high-output manufacturing, risk is everywhere—heavy
                  machinery, repetitive motion injuries, and chemical exposures.
                  MAC Safety embeds on-site specialists who combine
                  behavior-based safety programs with real-time risk
                  intelligence.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300">
                    Using NIXN&apos;s predictive analytics, we target high-risk
                    activities before they lead to costly injuries or shutdowns.
                    Our approach reduces OSHA violations, boosts workforce
                    engagement, and enhances operational efficiency.
                  </p>
                </div>
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-[#eba200]">
