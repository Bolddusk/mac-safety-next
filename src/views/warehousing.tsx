...
export default function WarehousingIndustry() {
  return (
    <div className="min-h-screen bg-[#0b0b0d] font-alliance">
      <section className="relative min-h-[100vh] md:min-h-[80vh] flex items-center pt-32">
        <div className="absolute inset-0">
          <img
            src="/uploads/warehouse : logistics industry.jpg"
            ...
            <div className="bg-[#16171a] border border-gray-800 rounded-2xl p-8 space-y-8">
              <div>
                ...
                <p className="text-gray-300">
                  ...
                  MAC Safety deploys specialized consultants who understand both
                  traditional and automated distribution center safety
                  requirements.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300">
                    NIXN&apos;s AI-driven platform monitors human-robot interactions,
                    tracks vehicle movements, and ensures proper material
                    handling—maximizing both safety and operational efficiency
